...
- "products[].name" must be uppercase fuel abbreviations:
  VLSFO, ULSFO, LSMGO, HSFO, IFO380CST, IFO180CST, IFO120CST, IFO30CST, IFO, MGO, MDO, ULSD, GASOIL, LUBE,
  LSIFO, ITEM, COMMISSION, HIRE, PAYMENT, CREDIT_NOTE, CUTTERSTOCK, PYGAS, BARGING_FEE
  Also accept: HFO → HSFO, MFO → IFO380CST, DMA → MGO, RMG → IFO380CST, IFO380 → IFO380CST

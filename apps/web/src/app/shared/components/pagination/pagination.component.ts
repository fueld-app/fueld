      ...
      <div class="mt-4 flex items-center justify-between text-sm text-gray-600">
        ...
        <div class="flex items-center gap-1">
          ...
          <button (click)="goTo(1)" [disabled]="currentPage() <= 1"
            class="rounded-md border border-gray-300 px-2 py-1.5 text-xs hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed"
            title="First page">
            ...
            @if (item.type === 'ellipsis') {
              ...
              <button (click)="goTo(item.page)" [disabled]="item.page === currentPage()"
                [class]="item.page === currentPage()
                  ? 'rounded-md border border-blue-500 bg-blue-50 px-2.5 py-1.5 text-xs font-medium text-blue-700'
                  : 'rounded-md border border-gray-300 px-2.5 py-1.5 text-xs hover:bg-gray-50'">
                {{ item.page }}
              </button>
            }
          }

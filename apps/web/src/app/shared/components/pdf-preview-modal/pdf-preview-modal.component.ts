            ...
            <div class="flex items-center gap-3">
              ...
              @if (!loading()) {
                @if (!waLinked()) {
                  ...
                  <button
                    disabled
                    class="inline-flex items-center gap-2 rounded-lg bg-gray-300 px-4 py-2 text-sm font-semibold
                           text-gray-500 shadow-sm cursor-not-allowed"
                    title="Link WhatsApp in Settings to send via WhatsApp"
                  >
